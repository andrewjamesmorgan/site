						...
						<div class="slider" id="revolutionSlider">
							<ul>
								<li data-transition="slideright" data-slotamount="13" data-masterspeed="800" >
									<img src="img/banners/Power_of_Attorney/Discussing_what_is_next.jpg" title="Discussing future plansm - power of attorney" name="Discussing future plansm - power of attorney" alt="Discussing future plansm - power of attorney" data-bgfit="cover" data-bgposition="left top" data-bgrepeat="no-repeat">
								</li>
								<li data-transition="slideright" data-slotamount="13" data-masterspeed="800" >
									<img src="img/banners/Power_of_Attorney/Discussing_Document.jpg" title="Power of Attorney - discussing plans" name="Power of Attorney - discussing plans" alt="Power of Attorney - discussing plans" data-bgfit="cover" data-bgposition="left top" data-bgrepeat="no-repeat">
								</li>
								<li data-transition="slideright" data-slotamount="13" data-masterspeed="800" >
									<img src="img/banners/Power_of_Attorney/Wellness_Illness" title="Power of Attorney - Crossroads between wellness and illnesss" name="Power of Attorney - Crossroads between wellness and illnesss" alt="Power of Attorney - Crossroads between wellness and illnesss" data-bgfit="cover" data-bgposition="left center" data-bgrepeat="no-repeat">
								</li>
								<li data-transition="slideright" data-slotamount="13" data-masterspeed="800" >
									<img src="img/banners/Power_of_Attorney/Depression.jpg" title="Power of Attorney - Mentail Illness" name="Power of Attorney - Mentail Illness" alt="Power of Attorney - Mentail Illness" data-bgfit="cover" data-bgposition="left top" data-bgrepeat="no-repeat">
								</li>
								<li data-transition="slideright" data-slotamount="13" data-masterspeed="800" >
									<img src="img/banners/Power_of_Attorney/Concerned_Lady.jpg" title="Power of Attorney - Concerned lady" name="Power of Attorney - Concerned lady" alt="Power of Attorney - Concerned lady" data-bgfit="cover" data-bgposition="left top" data-bgrepeat="no-repeat">
								</li>
							</ul>
						</div>
					</div>
					...
					<div class="container">
						<div class="row left">
							<div class="col-md-12">
								...
								<h3>Advice and information on Lasting Powers of Attorney</h3>
								<section class="toggle">
									<label>What is an LPA?</label>
								...
								<section class="toggle">
									<label>Who can make an LPA?</label>
									<div class="toggle-content" style="display: none;">
										<p>
								...
								<section class="toggle">
									<label>How to make an LPA</label>
									<div class="toggle-content" style="display: none;">
										<p>
								...
								<section class="toggle">
									<label>How many types of LPA are there?</label>
									<div class="toggle-content" style="display: none;">
										<p>
											There are now two different types of LPA, replacing the old Enduring Power of Attorney form:
											<ol>
												<li>A Property and Affairs LPA - allows your Attorney to make decisions on your behalf about your property and affairs, such as bills payment, receiving your income and benefits entitlements or selling your house, all subject to your restrictions and conditions. Property and Affairs Attorneys can be asked to manage your property and finances while you are still able and when you lack the capacity.</li>
												<li>A Personal Welfare LPA - allows your Attorney to make decisions on your behalf about your personal welfare, such as whether to give or refuse consent to medical treatment on your behalf and deciding where you live. They can only make these decisions on your behalf when you are no longer able to make them yourself, if you are ill, unconscious or because of the onset of a condition such a dementia. A Personal Welfare Attorney cannot make decisions on your behalf about your property and affairs.</li>
											</ol> 
										</p>
									</div>
								</section>
								<section class="toggle">
									<label>The LPA Form</label>
									<div class="toggle-content" style="display: none;">
										<p>
											There are currently three parts to complete on the LPA form:
											<ul>
												<li><strong>Part A - The Donor's Statement: </strong>
												This is where your details are inserted, as well as the details of the persons you want to appoint to make decisions for you in the future and how you want them to act on your behalf. This is also the part where any restrictions or conditions on the powers you grant can be expressed and where you are asked to give the names of the persons you want to be notified of the registration of the LPA.</li>
												<li><strong>Part B - The Certificate Provider's Statement:</strong>
												Not everyone can be a certificate provider. The form specifies who qualifies for the purpose. 
												The certificate provider must speak with you privately to make sure that you understand the powers you invest in your Attorneys and that there has been no fraud and no pressure was put on you to make the LPA. If you have not named anyone to be informed of the registration of the LPA in the allocated section in part A then you will need two certificate providers.</li>
												<li><strong>Part C - The Attorney's Statement:</strong>
												All your chosen Attorneys will need to provide their details and confirm that they understand their legal duties if they need to act as your Attorneys. All your named Attorneys will need to sign this section and ask for someone to witness their signatures. </li>
											</ul>
										</p>
									</div>
								</section>
								<section class="toggle">
									<label>Who can register the LPA?</label>
									<div class="toggle-content" style="display: none;">
										<p>
								...
								<section class="toggle">
									<label>Registering the LPA</label>
									<div class="toggle-content" style="display: none;">
										<p>
											WUpon registration of the LPA the person registering it must complete 2 forms:
											<ul>
												<li><strong>LPA001</strong> - Notice of intention to apply for registration of a Lasting Power of Attorney - aimed at notifying the persons you have named of the registration of the LPA so that they can object if they feel that you were in any way under pressure to make it.</li>
												<li><strong>LPA002</strong> - Application to register a Lasting Power of Attorney - this must be sent to the OPG with the LPA and the appropriate fee.</li>
											</ul>
										<p>
								...
								<section class="toggle">
									<label>When can an LPA be used?</label>
									<div class="toggle-content" style="display: none;">
										<p>
								...
								<section class="toggle">
									<label>What are the risks with an LPA and what precautions can be taken?</label>
									<div class="toggle-content" style="display: none;">
										<p>
								...
								<section class="toggle">
									<label>I have already made an Enduring Power of Attorney. What shall I do?</label>
									<div class="toggle-content" style="display: none;">
										<p>
								...
								<section class="toggle">
									<label>How much does it cost to make an LPA?</label>
									<div class="toggle-content" style="display: none;">
										<p>
											We can provide you with an estimate of our costs for the preparation of an LPA. Please refer to the <a href="Contact.php">contact page</a>.
										</p>
									</div>
								</section>
								<section class="toggle">
								...
								<section class="toggle">
									<label>Can anyone access information on the registers?</label>
									<div class="toggle-content" style="display: none;">
										<p>
								...
								<section class="toggle">
									<label>Do I have to live in England or Wales to make a Personal Welfare LPA?</label>
									<div class="toggle-content" style="display: none;">
										<p>
								...
								<section class="toggle">
									<label>Do I have to live in England or Wales to make a Property and Affairs LPA?<</label>
									<div class="toggle-content" style="display: none;">
										<p>
								...
								<section class="toggle">
									<label>Who can be an Attorney?</label>
									<div class="toggle-content" style="display: none;">
										<p>
								...
								<section class="toggle">
									<label>Are there restrictions to who can be an Attorney?</label>
									<div class="toggle-content" style="display: none;">
										<p>
								...
								<section class="toggle">
									<label>Can I appoint more than one Attorney?</label>
									<div class="toggle-content" style="display: none;">
										<p>
											Yes, you can appoint as many Attorneys as you wish. However, you will need to consider how you want them to act:
											<ul>
												<li>together; or </li>
												<li>together and independently of each other; or </li>
												<li>together in some matters and together and independently in others.</li>
											</ul>
										</p>
										<p>
										...
										<p>
											<strong>What is the difference between appointing Attorneys together or appointing them together and independently?</strong>
										</p>
										<p>
										...
										<p>
											<strong>What if my Attorney does not act in my best interest?</strong>
										</p>
										<p>
								...
								<section class="toggle">
									<label>Can I name the same Attorney for my Personal Welfare LPA as for my Property and Affairs LPA?</label>
									<div class="toggle-content" style="display: none;">
										<p>
								...
								<section class="toggle">
									<label>What is a named person?</label>
									<div class="toggle-content" style="display: none;">
										<p>
								...
								<section class="toggle">
									<label>Why do I need to appoint named persons?</label>
									<div class="toggle-content" style="display: none;">
										<p>
								...
								<section class="toggle">
									<label>What is a Certificate Provider?</label>
									<div class="toggle-content" style="display: none;">
										<p>
								...
								<section class="toggle">
									<label>Why do I need this certificate?</label>
									<div class="toggle-content" style="display: none;">
										<p>
								...
								<section class="toggle">
									<label>Who can be a Certificate Provider?</label>
									<div class="toggle-content" style="display: none;">
										<p>
											...
											<ul>
												<li>
													...
													<ul>
														<li><strong>Knowledge certification</strong> - A knowledge-based Certificate Provider is someone that you know personally and have done so for at least two years.</li>
													</ul>
												</li>
												<li>
													<strong>Category B</strong>
													<ul>
														<li><strong>Skills certification</strong> - A skills-based Certificate Provider is someone who considers that they have the relevant professional skills and expertise to certify your LPA.</li>
													</ul>
												</li>
											</ul>
										</p>
										<p>
											...
											<ul>
												<li>a registered healthcare professional (including a GP)</li>
												<li>a solicitor, barrister or advocate</li>
												<li>a registered social worker; or</li>
								...
								<section class="toggle">
									<label>Is there anyone who cannot be a Certificate Provider?</label>
									<div class="toggle-content" style="display: none;">
										<p>
											You cannot select anyone from the following list to be a Certificate Provider:
											<ul>
												<li>A member of your or your Attorney's family</li>
												<li>A business partner or paid employee of yours or your Attorney(s)</li>
												<li>An Attorney appointed in this form or another LPA or any EPA made by you or</li>
												<li>The owner, director, manager, or an employee of a care home in which you currently live or their family member.</li>
											</ul>
										</p>
									</div>
								</section>
								<section class="toggle">
									<label>Can my Certificate Provider charge for providing the certificate?</label>
									<div class="toggle-content" style="display: none;">
										<p>
								...
								<section class="toggle">
									<label>Can I still make decisions if my LPA is registered?</label>
									<div class="toggle-content" style="display: none;">
										<p>
