...
<html xmlns="http://www.w3.org/1999/xhtml">
   ...
   <meta name="description" content="Windsor Solicitor specialising in Wills & Probate, Family Law (Pre nuptials, Divorce, Separation, Inheritance), Children, Employment Law,  Estate Planning, Pensions and Civil Litigation."/>
  ...
  <div id="center"> 
  	<h2>Wills &amp; Probate </h2>
  	<p>A will is a  legal document expressly directing what should happen to your assets and who  should benefit from them on your death.</p>
  	...
  	<p>Furthermore  if the Will has not been drafted or executed correctly it could result in the  Will being invalid.</p>
  	<p>For more information, please refer to the following sections:</p>
  	<ul>
  	  <li><a href="NeedWill.jsp">Do you really need a Will?</a> </li>
...
<div class="Footer">
  ...
  <div id="centerRight"><img src="images/rhs/Wills_Probate.jpg" alt="Wills &amp; Probate" width="200" height="298" border="0"/></div>
