...
(function($){
        ...
        return {
            ...
            adjust: function(){
                ...
                for (var i = 0, len = styles.length; i < len; i++) {
                    if ((!(styles[i].min && styles[i].min > width) && !(styles[i].max && styles[i].max < width)) || (!styles[i].max && !styles[i].min)) {
    ...
    if (($.browser.msie && parseFloat($.browser.version, 10) < 9) || ($.browser.mozilla && parseFloat($.browser.version, 10) < 2)) {
        try {
